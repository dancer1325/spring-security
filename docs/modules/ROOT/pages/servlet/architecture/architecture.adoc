...
* print the security `Filters`  list
    **
    ** invoked / request
        *** uses
            **** check that <<adding-custom-filter,filter you have added>> is in the list of the security filters

at DEBUG level on the application startup
